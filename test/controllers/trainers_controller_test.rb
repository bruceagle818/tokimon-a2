...
class TrainersControllerTest < ActionController::TestCase
  ...
  test "should create trainer" do
    assert_difference('Trainer.count') do
      post :create, trainer: { level: @trainer.level, numberoftokimons: @trainer.numberoftokimons, pname: @trainer.pname }
    end
  ...
  test "should update trainer" do
    patch :update, id: @trainer, trainer: { level: @trainer.level, numberoftokimons: @trainer.numberoftokimons, pname: @trainer.pname }
    assert_redirected_to trainer_path(assigns(:trainer))
  end
